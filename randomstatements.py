...
statement_prompts = [
    ...
    "{player}: future MVP.",
    "{player}: future Cy Young winner.",
    "{player}: future Hall of Famer.",
    "{player}: future All-Star.",
    "{player}: future Gold Glover.",
    "{player}: future Silver Slugger.",
    "{player}: future batting champion.",
    "{player}: future World Series champion.",
    "{player}: future World Series MVP.",
    "{player} is the best player in baseball.",
    "{player} is the worst player in baseball.",
    "{player} is the most underrated player in baseball.",
    "{player} is the most overrated player in baseball.",
